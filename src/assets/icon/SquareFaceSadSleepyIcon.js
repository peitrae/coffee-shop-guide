...
const SquaredFaceSadSleepyIcon = ({ id, className }) => (
  <i className={className} id={id}>
    ...
    >
      <g>
        <path
          d="M23.507,51.13c-1.212-1.133-1.274-3.033-0.142-4.246c1.132-1.213,3.018-1.291,4.247-0.143
...
export default SquaredFaceSadSleepyIcon;
