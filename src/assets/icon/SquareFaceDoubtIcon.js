...
const SquaredFaceDoubtIcon = ({ id, className  }) => (
  <i className={className} id={id}>
    ...
    >
      <g>
        <path
          d="M24.857,38.623c0-1.738,1.409-3.147,3.147-3.147l13.373-0.001c0.027,0,0.054,0.007,0.081,0.008
...
export default SquaredFaceDoubtIcon;
